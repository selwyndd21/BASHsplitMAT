...
for (( inputcount=0; inputcount<$length; inputcount++ )) ; do
  ...
  while read -r line; do 
    ...
    if [[ ${array[0]} == [mM][0-9]* ]]; then
      ...
      python -O split.py $in_temp ${array[1] /\.*c/} ${array[2]} $fileCE $fileSAB ${MAT}
    ...
    ####################
      ...
      # argv[6]: new mCard file
      #                  argv[1]  argv[2]            argv[3]     argv[4] argv[5]  argv[6]
      python -O split.py $TinM    ${array[1] /\.*t/} 0           $fileCE $fileSAB ${MAT}
      cat $MAT >> ${case}_pseudo6000.inp
    ####################
    # Condition 3
    ####################
      ...
      # argv[6]: new mCard file
      #                  argv[1]  argv[2]            argv[3]     argv[4] argv[5]  argv[6]
      python -O split.py $in_temp ${array[0] /\.*c/} ${array[1]} $fileCE $fileSAB ${MAT}
      cat $MAT >> ${case}_pseudo6000.inp
      TinM=$in_temp
    ####################
    # Condition 4
